...
export class AnalyticsRepository {
    static async getHourlyDistribution(userId) {
    ...
    static async getDowDistribution(userId) {
        return await db.execute(sql `
    ...
    static async getTopProjects(userId) {
        return await db.execute(sql `
    ...
    static async getTopEntities(userId) {
        return await db.execute(sql `
    ...
    static async getSentimentTrend(userId) {
        return await db.execute(sql `
      SELECT 
    ...
    static async getCaptureTrend(userId) {
        return await db.execute(sql `
    ...
    static async getRecurringConcerns(userId) {
        return await db.execute(sql `
