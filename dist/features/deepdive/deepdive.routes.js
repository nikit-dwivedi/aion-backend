...
router.get('/:rawThoughtId', asyncHandler(async (req, res) => {
...
router.post('/:rawThoughtId/chat', checkQuota('deepdive'), asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { rawThoughtId } = req.params;
...
//# sourceMappingURL=deepdive.routes.js.map