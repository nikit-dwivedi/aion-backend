...
export class PlanningRepository {
    static async resolveNode(userId, nodeType, content, tx = db) {
    ...
    static async getRecentInsights(userId) {
        return await db
