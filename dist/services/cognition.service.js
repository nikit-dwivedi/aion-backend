export class CognitionService {
     ...
     */
    static calculateReinforcement(currentCount, currentMomentum, retrievalCount) {
     ...
     */
    static calculateEdgeDecay(relationType, sourceNodeType, sourceNodeSentiment, currentWeight) {
     ...
     */
    static calculateNodeDecay(currentMomentum) {
     ...
     */
    static evaluateNotificationFatigue(recentDispatchedCount, priority) {
...
//# sourceMappingURL=cognition.service.js.map