...
export class LoopDetectionService {
     ...
     */
    static async detectLoops(userId) {
        if (!llm.isConfigured) {
        ...
        for (const clusterIds of clusters) {
            ...
            let matchedLoop = activeLoops.find(lp => {
                const existingIds = lp.relatedMemoryIds;
      ...
      `;
            try {
                ...
                if (matchedLoop) {
                    ...
                    const mergedMemoryIds = Array.from(new Set([...matchedLoop.relatedMemoryIds, ...currentMemoryIds]));
...
//# sourceMappingURL=loop_detection.service.js.map